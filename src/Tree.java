...
public class Tree {
    ...
    public void destroyEdgeInner(Vertex v, Edge prev, Edge next){
        if (prev != null){
    ...
    public void addEdge(Edge edge, Vertex left, Vertex right, int weight){
    ...
    public boolean hasAtMostOneAdjacentEdge(Vertex vertex){
